    ...
    // dispatch
    {
        let dispatch_message_fn = || {
            let calldata = abi
                ...
                .expect("calldata");
            shared_state.transaction_to_l1(l1_bridge_addr, value + fee, calldata)
        };
        dispatch_message_fn()
            .await
        ...
        dispatch_message_fn()
            .await
            .expect_err("dispatch_message failure");
    }
    ...
    // drop
    {
        let drop_message_fn = || {
            let calldata = abi
                ...
                .expect("calldata");
            shared_state.transaction_to_l1(l1_bridge_addr, U256::zero(), calldata)
        };
        drop_message_fn().await.expect("drop_message success");
        drop_message_fn().await.expect_err("drop_message failure");
    }
    ...
    // dispatch
    {
        let dispatch_message_fn = || {
            let calldata = abi
                ...
                .expect("calldata");
            shared_state.transaction_to_l2(l2_bridge_addr, value + fee, calldata, None)
        };
    ...
    // drop
    {
        let drop_message_fn = || {
            let calldata = abi
                ...
                .expect("calldata");
            shared_state.transaction_to_l2(l2_bridge_addr, U256::zero(), calldata, None)
        };
